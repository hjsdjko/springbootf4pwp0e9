<template>
	<div class="addEdit-block" :style='{"padding":"85px 30px 30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="任务分类" prop="renwufenlei">
					<el-input v-model="ruleForm.renwufenlei" placeholder="任务分类" clearable  :readonly="ro.renwufenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-else class="input" label="任务分类" prop="renwufenlei">
					<el-input v-model="ruleForm.renwufenlei" placeholder="任务分类" readonly></el-input>
				</el-form-item>
			</template>
