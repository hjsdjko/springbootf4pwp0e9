<template>
	<div class="main-content" :style='{"color":"#3B3E40","padding":"30px 30px 30px","fontSize":"14px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('tushuxinxi','订单交易')" @click="dingdanjiaoyiCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
		...
		<dingdanjiaoyi-cross-add-or-update v-if="dingdanjiaoyiCrossAddOrUpdateFlag" :parent="this" ref="dingdanjiaoyiCrossaddOrUpdate"></dingdanjiaoyi-cross-add-or-update>
...
import dingdanjiaoyiCrossAddOrUpdate from "../dingdanjiaoyi/add-or-update";
	export default {
		data() {
			return {
				tushuleixingOptions: [],
				...
				dingdanjiaoyiCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			dingdanjiaoyiCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.dingdanjiaoyiCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.dingdanjiaoyiCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.dingdanjiaoyiCrossaddOrUpdate.init(row.id,type);
				});
			},
