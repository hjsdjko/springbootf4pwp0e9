	...
	<view :style='{"minHeight":"100vh","width":"100%","padding":"24rpx","position":"relative","background":"#f7f7f7","height":"auto"}'>
		<form :style='{"width":"100%","padding":"24rpx","borderRadius":"16rpx","background":"#fff","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","borderColor":"#ccc","alignItems":"center","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				...
				<input :style='{"border":"0","padding":"0px 24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","flex":"1","background":"rgba(255, 255, 255, 0)","fontSize":"28rpx","height":"80rpx"}' :disabled="ro.kucunshuliang" v-model.number="ruleForm.kucunshuliang" placeholder="库存数量" type="number"></input>
			</view>
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","borderColor":"#ccc","alignItems":"center","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
			...
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","borderColor":"#ccc","alignItems":"center","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class=" select">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}' class="title">交换时间</view>
				<picker  :disabled="ro.jiaohuanshijian" :style='{"width":"100%","flex":"1","height":"auto"}' mode="date" :value="ruleForm.jiaohuanshijian" @change="jiaohuanshijianChange">
					<view :style='{"width":"100%","padding":"0 0 0 20rpx","lineHeight":"80rpx","fontSize":"28rpx","color":"#333"}' class="uni-input">{{ruleForm.jiaohuanshijian?ruleForm.jiaohuanshijian:"请选择交换时间"}}</view>
				</picker>
			</view>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
            this.ruleForm.jiaohuanshijian = this.$utils.getCurDate();
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`tushujiaohuan`, this.ruleForm.id);
		...
		methods: {
			...
			jiaohuanshijianChange(e) {
				this.ruleForm.jiaohuanshijian = e.target.value;
				this.$forceUpdate();
			},
...
//跨表计算判断
				...
				if(this.ruleForm.kucunshuliang&&(!this.$validate.isIntNumer(this.ruleForm.kucunshuliang))){
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`tushujiaohuan`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`tushujiaohuan`, this.ruleForm);
						}else{
							await this.$api.add(`tushujiaohuan`, this.ruleForm);
						}
