<template>
	<view :style='{"minHeight":"100vh","padding":"24rpx","flexWrap":"wrap","background":"#f4f4f4","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto"}'>
		<view class="title" :style='{"margin":"0","color":"#333","borderRadius":"16rpx 16rpx 0 0","textAlign":"center","background":"#fff","width":"100%","lineHeight":"80rpx","fontSize":"32rpx"}'>{{detail.title}}</view>
		
		<view :style='{"width":"100%","padding":"0 24rpx","flexWrap":"wrap","background":"#fff","justifyContent":"center","display":"flex"}'>
		  ...
		  <view :style='{"padding":"0","margin":"0 20rpx 0 0"}'>
		    <text class="icon iconfont icon-geren11" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"24rpx","color":"#666"}'></text>
		...
		<view :style='{"padding":"0 24rpx 24rpx","alignItems":"center","borderRadius":"0","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","order":"8"}'>
		  <view :style='{"border":"2rpx solid #eaeaea","padding":"0 10rpx","alignItems":"center","borderRadius":"16rpx","display":"flex","height":"64rpx"}' @click="likeClick">
		  ...
		  <view :style='{"border":"2rpx solid #eaeaea","padding":"0 10rpx","alignItems":"center","borderRadius":"16rpx","display":"flex","height":"64rpx"}' @click="collectClick">
		...
		<div :style='{"padding":"0 24rpx 24rpx","alignItems":"center","borderRadius":"0 0 16rpx 16rpx","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto","order":"9"}'>
		  <div @click="prepDetailClick" :style='{"border":"2rpx solid #eaeaea","padding":"0 10rpx","lineHeight":"64rpx","fontSize":"28rpx","color":"#666","borderRadius":"16rpx"}'>上一篇：prev</div>
		  <div @click="nextDetailClick" :style='{"border":"2rpx solid #eaeaea","padding":"0 10rpx","lineHeight":"64rpx","fontSize":"28rpx","color":"#666","borderRadius":"16rpx"}'>下一篇：next</div>
		</div>
		

		<!-- 热门 -->
		<view class="hot" :style='{"width":"100%","margin":"40rpx 0","background":"none","height":"auto","order":"11"}'>
		  <view :style='{"padding":"0 24rpx","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20231204/95a8019e4c124905a4d8312108d54eea.png) no-repeat center top / 100% 100%","width":"100%","fontSize":"32rpx","lineHeight":"276rpx","height":"176rpx"}'>热门信息</view>
		  <view :style='{"padding":"12rpx 20rpx 24rpx","borderRadius":"0 0 16rpx 16rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <view v-for="(item,index) in hotList" :key="index" :style='{"width":"48%","margin":"20rpx 0 0 0","background":"#fff","height":"auto"}' @click="toDetail(item.id)">
			  <image :style='{"width":"100%","objectFit":"cover","borderRadius":"16rpx","display":"block","height":"200rpx"}' mode="aspectFill" :src="baseUrl + item.picture"></image>
		      <view :style='{"padding":"0 8rpx","lineHeight":"60rpx","fontSize":"28rpx","color":"#333","textAlign":"left"}'>{{ item.title }}</view>
		...
		<view class="recommend" :style='{"width":"100%","margin":"40rpx 0","background":"none","height":"auto","order":"12"}'>
		  <view :style='{"padding":"0 24rpx","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20231204/95a8019e4c124905a4d8312108d54eea.png) no-repeat center top / 100% 100%","width":"100%","fontSize":"32rpx","lineHeight":"276rpx","height":"176rpx"}'>热门推荐</view>
		  <view :style='{"padding":"12rpx 20rpx 24rpx","borderRadius":"0 0 16rpx 16rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
