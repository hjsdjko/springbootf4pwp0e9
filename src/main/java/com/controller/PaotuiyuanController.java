...
public class PaotuiyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		PaotuiyuanEntity u = paotuiyuanService.selectOne(new EntityWrapper<PaotuiyuanEntity>().eq("paotuizhanghao", username));
		if(u==null || !u.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		
		String token = tokenService.generateToken(u.getId(), username,"paotuiyuan",  "跑腿员" );
    ...
    public R register(@RequestBody PaotuiyuanEntity paotuiyuan){
    	...
    	PaotuiyuanEntity u = paotuiyuanService.selectOne(new EntityWrapper<PaotuiyuanEntity>().eq("paotuizhanghao", paotuiyuan.getPaotuizhanghao()));
		if(u!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        PaotuiyuanEntity u = paotuiyuanService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        u.setMima("123456");
        paotuiyuanService.updateById(u);
    ...
    public R save(@RequestBody PaotuiyuanEntity paotuiyuan, HttpServletRequest request){
        if(paotuiyuanService.selectCount(new EntityWrapper<PaotuiyuanEntity>().eq("paotuizhanghao", paotuiyuan.getPaotuizhanghao()))>0) {
    ...
    public R update(@RequestBody PaotuiyuanEntity paotuiyuan, HttpServletRequest request){
        //ValidatorUtils.validateEntity(paotuiyuan);
        if(paotuiyuanService.selectCount(new EntityWrapper<PaotuiyuanEntity>().ne("id", paotuiyuan.getId()).eq("paotuizhanghao", paotuiyuan.getPaotuizhanghao()))>0) {
            return R.error("跑腿账号已存在");
        }
